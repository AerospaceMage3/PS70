...
const char* ssid = "esp-cative";
const char* password = "";

// long black bar is x-axis
const int xLimit = D8;
// rodded bar is y-axis
const int yLimit = D7;

const int stepPinX = D6;
const int dirPinX = D3;
const int stepPinY = D5;
const int dirPinY = D4;
...
MicController mic(micPin, motorPin);
